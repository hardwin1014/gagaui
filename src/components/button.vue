...
>
  ...
  <span v-if="$slots.default"><slot></slot></span> <!--如果传插槽就显示-->
</button>
</template>
...
export default {
  ...
  created () {
    // console.log(this.type) // 拿到传过来的type属性
    // console.log(this.$slots)// 可以拿到所有的插槽
  },
  methods: {
    handleClick (e) {
      this.$emit('click', e)
